...
from hospital_utils import generate_map_url, suggest_hospital_type, get_emergency_warning
...
cost_info = {
    "Melanocytic nevi (NV)": "₹500 – ₹3,000 (consultation or cosmetic removal if needed)",
    "Melanoma (MEL)": "₹15,000 – ₹60,000 (initial tests, biopsy, early surgical care)",
    "Benign keratosis (BKL)": "₹1,500 – ₹6,000 (minor dermatology treatment)",
    "Basal cell carcinoma (BCC)": "₹10,000 – ₹40,000 (early-stage surgical removal)",
    "Actinic keratoses (AKIEC)": "₹2,000 – ₹10,000 (cryotherapy or topical medication)",
    "Vascular lesions (VASC)": "₹2,000 – ₹12,000 (laser or minor procedures)",
    "Dermatofibroma (DF)": "₹1,000 – ₹5,000 (removal only if necessary)"
}
...
def predict():
    ...
    if file:
        ...
        cost_estimate = cost_info.get(prediction, "Consult hospital for cost details.")
...
def hospitals():
    ...
    if request.method == 'POST':
        ...
        map_url = generate_map_url(city, hospital_type)
